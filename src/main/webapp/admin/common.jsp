...
<body>
	...
	<div class="row">
		<div class="col-md-12">
			...
			<h3 class="page-title">
				<spring:message code='<%=menuNameCn %>'/> <small><spring:message code='<%=menuNameEn %>'/></small>
			</h3>
			<ul class="page-breadcrumb breadcrumb">
				<li><i class="fa fa-home"></i> <a>主页</a> <i class="fa fa-angle-right"></i></li>
				<li><a><spring:message code='<%=menuName1 %>'/></a> <i class="fa fa-angle-right"></i></li>
				<li><a><spring:message code='<%=menuName2 %>'/></a></li>
			</ul>
