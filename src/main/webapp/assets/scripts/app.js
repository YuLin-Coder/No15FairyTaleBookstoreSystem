...
var App = function () {
    ...
    var handleSidebarMenu = function () {
        ...
        jQuery('.page-sidebar').on('click', ' li > a', function (e) {
            ...
            //清除选中状态
            menuContainer.find('span').remove('.selected');
            ...
            if($(this).parent('li').parent('ul').hasClass("sub-menu")){
            	$(this).parent('li').parent('ul').parent('li').children('a').append('<span class="selected"></span>');            	
            }
        ...
        //修改密码
        jQuery('#revisePassword').on('click', function (e) {
            e.preventDefault();
            //App.scrollTop();
    ...
    return {
        ...
        blockUI: function (el, centerY) {
            ...
            el.block({
            	...
            	message: '<img src="'+contextPath+'/assets/img/ajax-loading.gif" align="">',
