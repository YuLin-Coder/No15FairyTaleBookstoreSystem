...
<%@ page language="java" import="com.li.service.impl.GoodsServiceImpl" %>
<%@ page language="java" import="com.li.service.impl.ShoppingCartServiceImpl" %>
<%@ page language="java" import="com.li.service.ShoppingCartService" %>
<%@ page language="java" import="net.sf.json.JSONObject" %>
<%@ page language="java" import="com.li.model.ShoppingCart" %>
<%@ page language="java" import="com.li.model.CartItem" %>
<%@ page language="java" import="org.apache.commons.codec.binary.Base64"%>
<%@ page language="java" import="com.li.dao.GoodsMapper" %>
