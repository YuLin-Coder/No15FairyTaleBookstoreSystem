...
<body>
	<jsp:include page="/admin/pageHead.jsp" flush="true">
	   <jsp:param name="menuNameCn" value="订单管理"/>
	   <jsp:param name="menuNameEn" value="order setting"/>
	   <jsp:param name="menuName1"  value="订单管理"/>
	   <jsp:param name="menuName2"  value="订单管理"/>
	</jsp:include>
	<div class="row">
		<div class="col-md-12">				
			<div class="portlet box green">
					<div class="portlet-title">
						<div class="caption"><i class="fa fa-edit"></i>订单管理</div>
					</div>
					...
					<div class="modal-body">
						<form class="form-horizontal" id="myForm">
							<div class="form-group">
								<label class="col-sm-3 control-label row">订单名：</label>
								<div class="col-sm-9">
									<input class="form-control" id="ordername"></input>
								</div>
							</div>
						</form>
					</div>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/admin/order.js"></script>
  </body>
</html>